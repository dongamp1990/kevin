				...
				<div class="page-content">
					...
					<div class="page-bar">
						<ul class="page-breadcrumb">
							...
							<li><a href="javascript:void(0)">添加数据</a></i></li>
						</ul>
								...
								<div class="tab-content">
									<div class="portlet box blue-hoki">
										<div class="portlet-title">
											<div class="caption">
												<i class="fa fa-gift"></i>添加数据
											</div>
										</div>
										<div class="portlet-body form">
											<!-- BEGIN FORM-->
											<form action="data_manager_input_submit" class="form-horizontal" method="post" id="userForm">
												<div class="form-body">
													<div class="form-group">
														<label class="col-md-3 control-label">QT名称</label>
														<div class="col-md-4">
															<input type="text" class="form-control"
																placeholder="QT名称" name="qtName"/>
														</div>
													</div>
													<div class="form-group">
														...
														<div class="col-md-4">
															<input type="text" class="form-control"
																placeholder="QQ号码" name="qqNumber" id="qqNumber"/>
														</div>
													</div>
													<div class="form-group">
														...
														<div class="col-md-4">
															<input type="text" class="form-control"
																placeholder="手机号码" name="phoneNumber"/>
														</div>
													</div>
													<div class="form-group">
													...
													<div class="form-group">
														...
														<div class="col-md-8">
															<div class="col-md-3">
																<input type="hidden" class="form-control" placeholder="级别"
																name="level" id="level"/>
																...
																<select id="code" class="form-control input input-inline" name="code">
																	<c:if test="${not empty codes }">
																		<c:forEach items="${codes }" var="code">
																			<option value='<c:out value="${code.code_id }"></c:out>'>${code.code_name }</option>
																		</c:forEach>
																	</c:if>
																</select>
															</div>
													...
													<div class="form-group">
														...
														<div class="col-md-4">
															<textarea class="form-control" placeholder="违规记录"
																name="illegalityRecord" rows="5"></textarea>
														</div>
													</div>
													<div class="form-group">
														...
														<div class="col-md-4">
															<textarea class="form-control" placeholder="违规记录"
																name="illegalityPunish" rows="5"></textarea>
														</div>
													</div>
												</div>
