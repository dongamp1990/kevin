				...
				<div class="page-content">
					...
					<div class="page-bar">
						<ul class="page-breadcrumb">
							...
							<li><a href="javascript:void(0)">修改用户</a></i></li>
						</ul>
								...
								<div class="tab-content">
									<div class="portlet box blue-hoki">
										...
										<div class="portlet-body form">
											<!-- BEGIN FORM-->
											<form action="update_user_manager_input_submit" class="form-horizontal" method="post" id="userForm">
												<div class="form-body">
													<div class="form-group">
														<label class="col-md-3 control-label">登录名</label>
														<div class="col-md-4">
															<input type="text" class="form-control"
																placeholder="登录名" name="loginName" value="${user.login_name }">
													...
													<div class="form-group">
														...
														<div class="col-md-4">
															<input type="text" class="form-control"
																placeholder="用户名" name="userName" value="${user.user_name }">
														</div>
													</div>
													<div class="form-group">
